  ...
  <a class="navbar-brand" href="guest.php">A R C</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="my-requests-pub.php">Publication</a>
          <a class="dropdown-item" href="my-requests-prs.php">Presentation</a>
        </div>
      </li>
    </ul>
