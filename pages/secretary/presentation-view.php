...
<div class="col-md-3">
  ...
  echo "<div class='col-md-3'>";
    echo "<form method='POST' action='../../includes/presentation-sec-feedback.php?id=".$id."''>
  ...
  echo "<div class='form-row ml-3'>";
  echo "<div class='col-md-3'>";
     echo "<form method='POST' action='../../includes/prs-send-director.php?id=".$id."''>
  ...
  echo "</div>";
    ...
    <?php
  echo "<div class='col-md-3'>";
    echo "<form method='POST' action='../../includes/prs-return.php?id=".$id."''>
  ...
  echo "</div>";
    ...
    <?php
  echo "<div class='col-md-3'>";
    echo "<form method='POST' action='../../includes/prs-delete.php?id=".$id."''>
