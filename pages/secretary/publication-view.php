...
<div class="form-row">
  ...
  echo "<div class='col-md-3'>";
    echo "<form method='POST' action='../../includes/publication-sec-feedback.php?id=".$id."''>
      <textarea placeholder='Secretary Feedback' name='sec-feedback'></textarea><br>";
      echo "<button class='btn btn-dark' type='submit' name='submit' value='submit'> Add Feedback </button>
    </form>";
  ...
  echo "<div class='form-row ml-3'>";
  echo "<div class='col-md-3'>";
     echo "<form method='POST' action='../../includes/pub-send-director.php?id=".$id."''>
      <button class='btn btn-dark' type='submit' name='submit' value='submit'>Forward to Director</button>
    </form>";
  echo "</div>"
    ?>
    ...
    <?php
  echo "<div class='col-md-3'>";  
    echo "<form method='POST' action='../../includes/pub-return.php?id=".$id."''>
      <button class='btn btn-dark' type='submit' name='submit' value='submit'>Return to Applicant</button>
    </form>";
  echo "</div>";
    ?>
    ...
    <?php
  echo "<div class='col-md-3'>";
    echo "<form method='POST' action='../../includes/pub-delete.php?id=".$id."''>
