...
if ($result2-> num_rows > 0) {
    if ($row2 = $result2-> fetch_assoc()) {
      $_SESSION['prs_email_array2'] = $row2;
echo'
<div class="col-md-4">
<h3>Attachments</h3>
  <div class="form-row">
...
<!--button-->
  ...
  echo "<div class='col-md-3'>";
    echo "<form method='POST' action='../../includes/presentation-director-feedback.php?id=".$id."''>
      <textarea placeholder='Director Feedback' name='direc-feedback'></textarea><br>
      <button class='btn btn-dark' type='submit' name='submit' value='submit'> Submit Feedback</button>
    </form>";
  echo "</div>";
  echo "</div>";
    ?>
  ...
  echo "<div class='col-md-2'>";
     echo "<form method='POST' action='../../includes/prs-approve-director.php?id=".$id."''>
  ...
  echo "</div>";
    ...
    <?php
  echo "<div class='col-md-2'>";
     echo "<form method='POST' action='../../includes/prs-reject-director.php?id=".$id."''>
  ...
  echo "</div>";
    ...
    <?php
  echo "<div class='col-md-2'>";
    echo "<form method='POST' action='../../includes/d-prs-delete.php?id=".$id."''>
