  ...
  <div class="wrapper-form">
    <?php echo'<h2>'.$row['pub_title'].'</h2>'; ?>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="inputPublisher">Phone Number</label>
          <?php
          echo '<input type="text" class="form-control" id="inputPublisher" placeholder="Publisher" name="publisher" value="'.$row['pub_phone'].'" readonly>';
          ?>
        </div>
      </div>
<!--Check box-->
...
echo '<div class="col-md-3">
  ...
  <div class="form-group">
      <p><a href="../../uploads/'.$row2['pub_file'].'" download>DOWNLOAD ATTACHMENT</a></p>
  </div>
</div>';
          }
      }
